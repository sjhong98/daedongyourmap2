"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[380],{3771:function(e,t,r){r.d(t,{C:function(){return signOut},aa:function(){return createUserWithEmailAndPassword},ab:function(){return signInWithEmailAndPassword},ag:function(){return sendEmailVerification},ak:function(){return updateProfile},o:function(){return getAuth}});var i,n=r(8745),s=r(3991),a=r(6914),o=r(44),l=r(5538);function _prodErrorMap(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}let c=new n.LL("auth","Firebase",_prodErrorMap()),u=new a.Yd("@firebase/auth");function _logError(e,...t){u.logLevel<=a.in.ERROR&&u.error(`Auth (${s.Jn}): ${e}`,...t)}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function recachePasswordPolicy(e){let t=_castAuth(e);t._getPasswordPolicyInternal()&&await t._updatePasswordPolicy()}async function createUserWithEmailAndPassword(e,t,r){let i=_castAuth(e),n=handleRecaptchaFlow(i,{returnSecureToken:!0,email:t,password:r,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",signUp),s=await n.catch(t=>{throw"auth/password-does-not-meet-requirements"===t.code&&recachePasswordPolicy(e),t}),a=await UserCredentialImpl._fromIdTokenResponse(i,"signIn",s);return await i._updateCurrentUser(a.user),a}function signInWithEmailAndPassword(e,t,r){return signInWithCredential((0,n.m9)(e),EmailAuthProvider.credential(t,r)).catch(async t=>{throw"auth/password-does-not-meet-requirements"===t.code&&recachePasswordPolicy(e),t})}async function sendEmailVerification(e,t){let r=(0,n.m9)(e),i=await e.getIdToken(),s={requestType:"VERIFY_EMAIL",idToken:i};if(t){var a,o;a=r.auth,_assert((null===(o=t.url)||void 0===o?void 0:o.length)>0,a,"invalid-continue-uri"),_assert(void 0===t.dynamicLinkDomain||t.dynamicLinkDomain.length>0,a,"invalid-dynamic-link-domain"),s.continueUrl=t.url,s.dynamicLinkDomain=t.dynamicLinkDomain,s.canHandleCodeInApp=t.handleCodeInApp,t.iOS&&(_assert(t.iOS.bundleId.length>0,a,"missing-ios-bundle-id"),s.iOSBundleId=t.iOS.bundleId),t.android&&(_assert(t.android.packageName.length>0,a,"missing-android-pkg-name"),s.androidInstallApp=t.android.installApp,s.androidMinimumVersionCode=t.android.minimumVersion,s.androidPackageName=t.android.packageName)}let{email:l}=await sendEmailVerification$1(r.auth,s);l!==e.email&&await e.reload()}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let E=new Delay(3e4,6e4);function resetUnloadedGapiModules(){let e=_window().___jsl;if(null==e?void 0:e.H){for(let t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}}let S=null,k=new Delay(5e3,15e3),A={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},R=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);async function _openIframe(e){let t=await (S=S||new Promise((t,r)=>{var i,n,s,a;function loadGapiIframe(){resetUnloadedGapiModules(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{resetUnloadedGapiModules(),r(_createError(e,"network-request-failed"))},timeout:E.get()})}if(null===(n=null===(i=_window().gapi)||void 0===i?void 0:i.iframes)||void 0===n?void 0:n.Iframe)t(gapi.iframes.getContext());else if(null===(s=_window().gapi)||void 0===s?void 0:s.load)loadGapiIframe();else{let t=_generateCallbackName("iframefcb");return _window()[t]=()=>{gapi.load?loadGapiIframe():r(_createError(e,"network-request-failed"))},(a=`${g.gapiScript}?onload=${t}`,g.loadJS(a)).catch(e=>r(e))}}).catch(e=>{throw S=null,e})),r=_window().gapi;return _assert(r,e,"internal-error"),t.open({where:document.body,url:function(e){let t=e.config;_assert(t.authDomain,e,"auth-domain-config-required");let r=t.emulator?_emulatorUrl(t,"emulator/auth/iframe"):`https://${e.config.authDomain}/__/auth/iframe`,i={apiKey:t.apiKey,appName:e.name,v:s.Jn},a=R.get(e.config.apiHost);a&&(i.eid=a);let o=e._getFrameworks();return o.length&&(i.fw=o.join(",")),`${r}?${(0,n.xO)(i).slice(1)}`}(e),messageHandlersFilter:r.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:A,dontclear:!0},t=>new Promise(async(r,i)=>{await t.restyle({setHideOnLeave:!1});let n=_createError(e,"network-request-failed"),s=_window().setTimeout(()=>{i(n)},k.get());function clearTimerAndResolve(){_window().clearTimeout(s),r(t)}t.ping(clearTimerAndResolve).then(clearTimerAndResolve,()=>{i(n)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function(e){switch(e){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}(i)),(0,s.KN)(L,U,"esm2017")}}]);